...
#naturalness
rel_likert_nat <- read.csv(".../reliability_subsets/rel_sub_likert_nat_time_10000_new.csv", na.strings=c("","NA"))
rel_slider_nat <- read.csv(".../reliability_subsets/rel_sub_slider_nat_time_10000_new.csv", na.strings=c("","NA"))
rel_pair_nat <- read.csv(.../reliability_subsets/rel_sub_pair_nat_time_10000_new.csv", na.strings=c("","NA"))
rel_fire_nat <- read.csv(.../reliability_subsets/rel_sub_fire_nat_time_10000_new.csv", na.strings=c("","NA"))
```
